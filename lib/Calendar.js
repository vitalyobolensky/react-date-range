...
var Calendar = (function (_Component) {
    ...
    _createClass(Calendar, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            var shownDate = nextProps.shownDate;

            var oldRange = this.props.oldRange;

            this.setState({
                shownDate: (0, _utilsParseInputJs2['default'])(nextProps.date, this.props.format, 'startOf'),
                date: (0, _utilsParseInputJs2['default'])(nextProps.date, this.props.format, 'startOf')
            });
        }
    }, {
        key: 'getShownDate',
        ...
        value: function renderWeekdays(classes) {
            ...
            for (var i = dow; i < 7 + dow; i++) {
                ...
                weekdays.push(_react2['default'].createElement(
                    'span',
                    { style: onlyClasses ? undefined : styles['Weekday'], className: classes.weekDay,
                        key: i + day },
                    day
                ));
            }
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                'div',
                { style: onlyClasses ? undefined : _extends({}, styles['Calendar'], this.props.style),
